    ...
    <section className="flex flex-col items-center gap-10 md:gap-16 pb-24 md:pb-52 px-4 md:px-6 w-full">
      ...
      <div className="flex flex-col md:flex-row gap-8 md:gap-[60px] max-w-[1024px]">
        ...
        <motion.div
          ...
          className="w-full md:w-[465px] h-[500px] sm:h-[580px] md:h-[661px] shrink-0 relative mx-auto md:mx-0 max-w-[465px]"
        >
          <Image
        ...
        <motion.p
          ...
          className="font-helvetica text-lg md:text-2xl font-normal leading-[1.4] tracking-[-0.24px] text-[var(--color-black)] flex-1 whitespace-pre-line"
        >
